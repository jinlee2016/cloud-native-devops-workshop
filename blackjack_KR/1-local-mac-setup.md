...
애플리케이션 서버, Oracle Application Cloud를위한 프로비저닝 기능 
...
6. **JDK 8 업데이트 121.pkg**아이콘을 클릭하면 설치가 표시됩니다. 
...
JAVA \ _HOME 및 PATH를 설정하고 참고하십시오. 
환경 변수 
...
2. ~ / .bash \ _profile 파일을 제어 할 수 있습니다. 
...
1. **자바 버전 확인 : **터미널 창에서 자바 
-version`을 사용합니다. JRE가 선택하지 못했습니다. 
JDK가 설치 가능합니다. Java output 
...
1. 터미널 창을 지우고 - 버젼 전환 명령. 

    <img src="images/1m/image5.png" width="568" height="111" />

**참고 : **이 명령은 설치가 불가능한 GIT 도구입니다. 

2. **설치**버튼을 클릭하십시오. 

    <img src="images/1m/image6.png" width="457" height="190" />

3. **동의 함**버튼을 사용하면 라이센스를 클릭하십시오. 

4. 설치 프로그램이 GIT 확장 프로그램에 자동 설치되었습니다. 
&quot;**소프트웨어가 설치되었습니다.**&quot;메시지가 있습니다. 클릭 
**완료**버튼. 

### GIT 설치 확인

1. **GIT 확장 확인 : **터미널 창에서 &#39;아이 
