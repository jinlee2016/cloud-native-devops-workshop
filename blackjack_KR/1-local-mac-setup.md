...
애플리케이션 서버, 오라클 애플리케이션 클라우드를위한 프로비저닝 기능 
...
-version`을 사용하십시오. JRE는 선택하지 못합니다. 
JDK가 설치 가능합니다. 자바 출력 
...
**참고 :** 이 명령은 GIT 도구를 설치해야합니다. 

2. **설치**버튼을 클릭하십시오. 

    <img src="images/1m/image6.png" width="457" height="190" />

3. **동의 함**버튼을 클릭하면 사용이 가능합니다. 

4. 설치 프로그램이 GIT 확장 프로그램을 자동 설치했습니다. 
